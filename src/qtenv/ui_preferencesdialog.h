...
public:
    ...
    void setupUi(QDialog *PreferencesDialog)
    {
        ...
        animationSpeedNoteLabel->setObjectName(QString::fromUtf8("animationSpeedNoteLabel"));
...
"  - %> function call depth times 2-space indentation (see Enter_M"
        ...
        animationSpeedNoteLabel->setText(QApplication::translate("PreferencesDialog", "The speed of the animations is influenced by the values set in the <a href=\"#toggleAnimParamsDialog\">Animation Parameters dialog</a> and the <code>cCanvas::setAnimationSpeed()</code> calls made by the model.", nullptr));
